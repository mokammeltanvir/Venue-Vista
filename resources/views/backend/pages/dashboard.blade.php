                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">BOOKINGS</div>
                                <div class="text-primary cta-4">{{ $total_booking_count }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">ALL LOCATIONS</div>
                                <div class="text-primary cta-4">{{ $all_locations }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="mb-1 d-flex align-items-center text-alternate text-small lh-1-25">ALL VENUES</div>
                                <div class="text-primary cta-4">{{ $total_venues }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 col-lg-2">
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                <div class="text-primary cta-4">{{ $total_testimonials }}</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    const myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: '# of Bookings',
                data: <?php echo json_encode($booking_yearwise) ?>,
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',

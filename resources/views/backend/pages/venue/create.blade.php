                    ...
                    <form action="{{ route('venue.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" name="venue_price" min="0"
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" name="venue_capacity" min="0"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="venue_address" min="0"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="venue_description" class="form-control @error('venue_description') is-invalid @enderror" id="venue_description" id="" cols="30" rows="5"></textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="file" class="form-control dropify" name="venue_image" id="">
                                @error('venue_image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
